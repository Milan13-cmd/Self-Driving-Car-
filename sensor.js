class Sensor{
  constructor(car){
    ...
    this.raySpread = Math.PI / 2; // Angle spread of the rays (90 degrees)
  ...
  draw(ctx){
    for(let i = 0; i < this.rayCount; i++){
      ...
      // Draw the part of the ray beyond the intersection
      ctx.beginPath()
      ctx.lineWidth = 2;
